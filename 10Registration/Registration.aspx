    ...
    <div class="wrapper">
        <form id="form1" runat="server" enctype="multipart/form-data" enableviewstate="true">
            <h1>Animagraphy Registration Page</h1>
                <div class="input-box">
                    <div class="input-field"><asp:Textbox id="fname" placeholder="First Name" 
                        required="required" runat="server"/>
                    </div>
                    <div class="input-field"><asp:Textbox id="lname" placeholder="Last Name" 
                        required="required" runat="server"/>
                    </div>
                    ...
                    <div class="input-field"><asp:Textbox id="email" placeholder="Email"
                        required="required" runat="server"/>
                    </div>
                    <div class="input-field"><asp:Textbox id="username" placeholder="Username" 
                        required="required" runat="server"/>
                    </div>
                    <div class="input-field"><asp:Textbox id="pwd" placeholder="Password" TextMode="Password"
                        required="required" runat="server"/>
                    </div>                    
                </div>
