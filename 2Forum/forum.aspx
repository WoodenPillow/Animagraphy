            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="navbar-menu-left-side239">
                        <ul>
                            <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i>Home</a></li>
                            <li><a href="\10Registration\Registration.aspx"><i class="fa fa-headphones" aria-hidden="true"></i>Register</a></li>
                            <li><a href="\9Login\Login.aspx"><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Question Category<span class="caret"></span></a>
                            <ul class="dropdown-menu animated zoomIn">
                                ...
                                <li><a href="forum.aspx">Animal Fun Facts</a></li>
                                <li><a href="forum.aspx">Wildlife ConservationL</a></li>
                                <li><a href="forum.aspx">Animal Rescue and Rehabilitation</a></li>
                                <li><a href="forum.aspx">Endangered Species Awarenest</a></li>
                        ...
                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Page <span class="caret"></span></a>
                            <ul class="dropdown-menu animated zoomIn">
                                <li><a href="\2Forum\post.aspx"> Post-Questions </a></li>
                                <li><a href="\3WorldMap\worldmap.aspx"> WorldMap </a></li>
                                <li><a href="\4Ranking\resources\ranking.aspx"> Leaderboard </a></li>
                                <li><a href="\5Dictionary\A-Z Dictionary.aspx"> Dictionary </a></li>
                                <li><a href="\6TableSearch\Table Search.aspx"> Table Search </a></li>
                                <li><a href="\7Matching\Matching.aspx"> Matching </a></li>
                            </ul>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="welcome-demop102 text-center">
                ...
                <div class="button0239-item">
                    ...
                    <a href="#">
                        <button type="button" class="join92">Join Member</button>
                    </a>
                </div>
                <div class="form-style8292">
                    <div class="input-group"> <span class="input-group-addon"><i class="fa fa-pencil-square" aria-hidden="true"></i></span>
                        <input type="text" class="form-control form-control8392" placeholder="Ask any question and you be sure find your answer ?"> <span class="input-group-addon"><a href="#">Search</a></span> </div>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="col-md-9">
                                        <div class="right-description893">
                                            <div id="que-hedder2983">
                                                <h3><a href="post-deatils.html" target="_blank">How Did You Hear About This Position?</a></h3> </div>
                            ...
                            <div class="question-type2033">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="right-description893">
                                            <div id="que-hedder2983">
                                                <h3><a href="post-deatils.html" target="_blank">Why Do You Want to Work at This Company?</a></h3> </div>
                                            <div class="ques-details10018">
                            ...
                            <div class="question-type2033">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="right-description893">
                                            <div id="que-hedder2983">
                                                <h3><a href="post-deatils.html" target="_blank">Why Do You Want This Job?</a></h3> </div>
                                            <div class="ques-details10018">
                                                <p>Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.</p>
                                            </div>
                                            <hr>
                            ...
                            <div class="question-type2033">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="right-description893">
                                            <div id="que-hedder2983">
                                                <h3><a href="post-deatils.html" target="_blank">Why Should We Hire You?</a></h3> </div>
                                            <div class="ques-details10018">
                                                <p>Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.</p>
                                            </div>
                                            <hr>
